...
class Tokenizer:
	def __init__(self, input_file):
		self.file = open((input_file + ".jack"), "r")
	...
	def remove_comments(self):
		inside_multicomment = False #flag 
		for i in self.file:
			line = i.strip()
	...
	def advance(self, expected="NONE"):
		...
		if expected != self.token and expected != "NONE":
			print("ERROR expected a " + expected )
		print(str(self.current_line) + "   " + repr(self.token))
		return self.token
